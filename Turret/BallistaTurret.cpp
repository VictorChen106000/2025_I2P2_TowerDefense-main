...
const int BallistaTurret::Price = 250;   

BallistaTurret::BallistaTurret(float x, float y)
    : Turret(
...
void BallistaTurret::setBulletImages() {
    bulletImages = {
        "play/peluruhitam.png", // L1
        "play/peluruhitam.png",// L2
        "play/peluruhitam.png" // L3
    };
}

void BallistaTurret::setlevelimages() {
    levelImages.push_back("play/tankrrr1.png");  // Level 1 image
    levelImages.push_back("play/tankrrr2.png");  // Level 2 image
    levelImages.push_back("play/tankrrr3.png");  // Level 3 image
}

void BallistaTurret::applylevelstats() {
    switch (level) {
        case 1:
...
void BallistaTurret::CreateBullet() {
