...
RocketBullet::RocketBullet(Engine::Point position, Engine::Point forwardDirection, float rotation, Turret* parent, Enemy* target, std::string img)
    : Bullet(img, 500, 1, position, forwardDirection, rotation - ALLEGRO_PI / 2, parent)
    , _target(target)
    , _turnRate(ALLEGRO_PI) {}
